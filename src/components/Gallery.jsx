...
const desktopImgs = [
    ...
    [
        ...
        {imgs: [
            {img: desktopGallery.memoriesImg, isFiller: true, id: 'memories'}
        ], isX: false}
    ]
];
        ...
        <section id="gallery">
            {
                isMobile
                    ...
                    :createDesktopGallery(desktopImgs)
            }
        </section>
    );
}
